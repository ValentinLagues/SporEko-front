...
type OfferContent = {
  ...
  creation_date: Date;
  setCreation_date: React.Dispatch<React.SetStateAction<Date>>;
  ...
  purchase_date: Date;
  setPurchase_date: React.Dispatch<React.SetStateAction<Date>>;
...
export const CurrentUserContextProvider: React.FC<Props> = ({ children }) => {
  ...
  const [creation_date, setCreation_date] = useState<Date>(0000-00-00 00:00:00);
  ...
  const [purchase_date, setPurchase_date] = useState<Date>(0000-00-00 00:00:00);
